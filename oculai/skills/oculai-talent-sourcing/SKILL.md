...
8. Request human approval before any outreach or external write
...
11. oculai_export_report      → Generate final report
12. Launch Outreach Strategist → If user wants outreach
13. Present shortlist + outreach drafts to user
```
